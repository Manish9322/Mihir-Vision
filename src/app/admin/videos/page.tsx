...
const VideoForm = ({ video, onSave }: { video?: VideoInfo | null, onSave: (video: VideoInfo) => void }) => {
...
const VideosAdminPage = () => {
    const { toast } = useToast();
    const [videos, setVideos] = useState<VideoInfo[]>(videoData);
        ...
        <>
                                    ...
                                    <TableRow key={video.id}>
                                        <TableCell className="text-center align-middle">
                                            <div className="flex flex-col items-center gap-1">
                                                ...
                                                <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => handleMove(index, 'down')} disabled={(currentPage - 1) * ITEMS_PER_PAGE + index === videos.length - 1}>
            ...
            <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                <DialogContent className="sm:max-w-lg">
                    ...
                    <VideoForm video={selectedVideo} onSave={handleSave} />
                </DialogContent>
            </Dialog>
